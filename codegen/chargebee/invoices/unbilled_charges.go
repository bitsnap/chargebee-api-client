...
func GenerateListInvoiceUnBilledCharges() string {
	return client.GenerateList("InvoiceUnbilledCharges", "InvoiceUnbilledCharge", "chargebee.com/api/v2/unbilled_charges")
}
...
func GenerateInvoiceUnBilledChargeModel() string {
	return client.GenerateModel("InvoiceUnbilledCharge", "Unbilled charge attributes", "https://apidocs.chargebee.com/docs/api/unbilled_charges")
}
