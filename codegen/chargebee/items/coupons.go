...
func GenerateListItemCoupons() string {
	return client.GenerateList("Coupons", "Coupon", "chargebee.com/api/v2/coupons")
}
...
func GenerateRetrieveItemCoupon() string {
	return client.GenerateRetrieve("Coupon", "chargebee.com/api/v2/coupons")
}
...
func GenerateItemCouponModel() string {
	return client.GenerateModel("Coupon", "Coupon attributes", "https://apidocs.chargebee.com/docs/api/coupons")
}
