...
func GenerateListSubscriptions() string {
	return client.GenerateList("Subscriptions", "Subscription", "chargebee.com/api/v2/subscriptions")
}
...
func GenerateRetrieveSubscriptionWithScheduledChanges() string {
	return client.GenerateListChildren("SubscriptionWithScheduledChanges", "Subscription", "chargebee.com/api/v2/subscriptions", "retrieve_with_scheduled_changes")
}
...
func GenerateSubscriptionsModel() string {
	return client.GenerateModel("Subscription", "Subscription attributes", "https://apidocs.chargebee.com/docs/api/subscriptions")
}
