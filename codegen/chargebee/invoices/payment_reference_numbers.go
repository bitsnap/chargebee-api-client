...
func GenerateListInvoicePaymentReferenceNumbers() string {
	return client.GenerateListChildrenWithId("PaymentReferenceNumbers", "PaymentReferenceNumber", "chargebee.com/api/v2/invoices", "payment_reference_numbers", false, "")
}
...
func GenerateInvoicePaymentReferenceNumberModel() string {
	return client.GenerateModel("PaymentReferenceNumber", "Payment reference number attributes", "https://apidocs.chargebee.com/docs/api/payment_reference_numbers")
}
