...
func GenerateListSubscriptionContractTerms() string {
	return client.GenerateListChildren("ContractTerms", "ContractTerm", "chargebee.com/api/v2/subscriptions", "contract_terms")
}
...
func GenerateSubscriptionContractTermsModel() string {
	return client.GenerateModel("ContractTerm", "Address attributes", "https://apidocs.chargebee.com/docs/api/contract_terms")
}
