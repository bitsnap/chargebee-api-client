...
func GenerateListVirtualBankAccounts() string {
	return templates.GenerateList("VirtualBankAccounts", "VirtualBankAccount", "chargebee.com/api/v2/virtual_bank_accounts")
}
...
func GenerateRetrieveVirtualBankAccount() string {
	return templates.GenerateRetrieve("VirtualBankAccount", "chargebee.com/api/v2/virtual_bank_accounts")
}
...
func GenerateVirtualBankAccountsModel() string {
	return templates.GenerateModel("VirtualBankAccount", "Virtual bank account attributes", "https://apidocs.chargebee.com/docs/api/virtual_bank_accounts")
}
