...
func GenerateListItemAttached() string {
	return templates.GenerateListChildren("ItemsAttached", "ItemAttached", "chargebee.com/api/v2/items", "attached_items")
}
...
func GenerateRetrieveItemAttached() string {
	return templates.GenerateRetrieve("ItemAttached", "chargebee.com/api/v2/attached_items")
}
...
func GenerateItemAttachedModel() string {
	return templates.GenerateModel("ItemAttached", "Attached item attributes", "https://apidocs.chargebee.com/docs/api/attached_items")
}
