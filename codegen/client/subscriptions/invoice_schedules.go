...
func GenerateListSubscriptionAdvancedInvoiceSchedule() string {
	return templates.GenerateListChildren("AdvancedInvoiceSchedules", "AdvancedInvoiceSchedule", "chargebee.com/api/v2/subscriptions", "retrieve_advance_invoice_schedule")
}
...
func GenerateSubscriptionAdvancedInvoiceScheduleModel() string {
	return templates.GenerateModel("AdvancedInvoiceSchedule", "Advance invoice schedule attributes", "https://apidocs.chargebee.com/docs/api/advance_invoice_schedules")
}
