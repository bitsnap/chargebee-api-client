...
func GenerateListItemPrices() string {
	return templates.GenerateList("ItemPrices", "ItemPrice", "chargebee.com/api/v2/item_prices")
}
...
func GenerateRetrieveItemPrice() string {
	return templates.GenerateRetrieve("ItemPrice", "chargebee.com/api/v2/item_prices")
}
...
func GenerateItemPriceModel() string {
	return templates.GenerateModel("ItemPrice", "Item price attributes", "https://apidocs.chargebee.com/docs/api/item_prices")
}
