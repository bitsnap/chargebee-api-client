...
func GenerateListSubscriptionEntitlements() string {
	return client.GenerateListChildren("SubscriptionEntitlements", "SubscriptionEntitlement", "chargebee.com/api/v2/subscriptions", "subscription_entitlements")
}
...
func GenerateSubscriptionEntitlementsModel() string {
	return client.GenerateModel("SubscriptionEntitlement", "Subscription entitlement attributes", "https://apidocs.chargebee.com/docs/api/subscription_entitlements")
}
