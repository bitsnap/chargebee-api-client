...
func GenerateListItemCouponSets() string {
	return templates.GenerateList("CouponSets", "CouponSet", "chargebee.com/api/v2/coupon_sets")
}
...
func GenerateRetrieveItemCouponSet() string {
	return templates.GenerateRetrieve("CouponSet", "chargebee.com/api/v2/coupon_sets")
}
...
func GenerateItemCouponSetModel() string {
	return templates.GenerateModel("CouponSet", "Coupon set attributes", "https://apidocs.chargebee.com/docs/api/coupon_sets")
}
