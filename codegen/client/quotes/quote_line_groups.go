...
func GenerateListQuoteLineGroups() string {
	return templates.GenerateListChildren("QuoteLineGroups", "QuoteLineGroup", "chargebee.com/api/v2/quotes", "quote_line_groups")
}
...
func GenerateListAllQuoteLineGroups() string {
	return templates.GenerateList("AllQuoteLineGroups", "QuoteLineGroup", "chargebee.com/api/v2/quote_line_groups")
}
...
func GenerateRetrieveQuoteLineGroup() string {
	return templates.GenerateModel("QuoteLineGroup", "Quote line group attributes", "https://apidocs.chargebee.com/docs/api/quote_line_groups")
}
